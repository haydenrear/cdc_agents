...
from cdc_agents.agents.cdc_server_agent import CodeSearchAgent, CdcServerAgentToolCallProvider
...
@injectable()
class TestGraphCdcCodeSearchAgent(CodeSearchAgent, TestGraphOrchestrated):
    """
    ...
    def __init__(self, agent_config: AgentConfigProps, memory_saver: MemorySaver, model_provider: ModelProvider,
        ...
        CodeSearchAgent.__init__(self, agent_config, memory_saver, model_provider, cdc_server, tool_call_provider, TestGraphOrchestrated)
