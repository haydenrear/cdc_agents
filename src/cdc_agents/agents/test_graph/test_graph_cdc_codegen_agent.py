...
from cdc_agents.agents.cdc_server_agent import CodegenAgent, CdcServerAgentToolCallProvider
...
@injectable()
class TestGraphCdcCodegenAgent(CodegenAgent, TestGraphOrchestrated):
    """
    ...
    def __init__(self, agent_config: AgentConfigProps, memory_saver: MemorySaver,
        ...
        CodegenAgent.__init__(self, agent_config, memory_saver, model_provider, cdc_server, tool_call_provider, TestGraphOrchestrated)