...
from cdc_agents.agents.cdc_server_agent import BaseCdcCodegenAgent, CdcServerAgentToolCallProvider
...
@injectable()
class TestGraphCdcCodegenAgent(BaseCdcCodegenAgent, TestGraphOrchestrated):
    """
    ...
    def __init__(self, agent_config: AgentConfigProps, memory_saver: MemorySaver,
        ...
        BaseCdcCodegenAgent.__init__(self, agent_config, memory_saver, model_provider, cdc_server, tool_call_provider, TestGraphOrchestrated)